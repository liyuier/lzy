...
class GQA:
    ...
    def train(self, train_tuple, eval_tuple):
        ...
        val_in_epoch = np.linspace(0, len(loader), 5, dtype=np.int_)[1:-1]  # 3
        ...
        for epoch in range(args.epochs):
            ...
            for i, (ques_id, feats, boxes, sent, target, adj_true, # a_embed_true
                ...
                if random_num <= args.delta:
                    ...
                    adj_noise[adj_temp == 1] = self.model.encoder_adj(x).view(-1)
                    ...
                    # Adversarial loss
                    d_loss = compute_kl_loss(adj_noise, adj_true) * target.size(1)
                    loss_grad = loss_func(
    ...
    def evaluate(self, eval_tuple: DataTuple, dump=None):
        ...
        x = eval_tuple.evaluator.evaluate(quesid2ans)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train", default="train", type=str, help="开始训练")
    parser.add_argument("--test", default='testdev_all', type=str, help="开始训练")
    # parser.add_argument("--test", default=None, type=str, help="开始训练")
    parser.add_argument("--tqdm", default=True, type=str, help="开始训练")
    parser.add_argument("--valid", default="val_tail", type=str, help="开始测试")
    parser.add_argument("--llayers", default=9, type=int, help="层数")
    parser.add_argument("--xlayers", default=5, type=int, help="层数")
    parser.add_argument("--rlayers", default=5, type=int, help="层数")
    parser.add_argument("--load", default='F:/VQA/相关代码/X-GGM-main/output/BEST_4', type=str, help="预训练模型")
    #parser.add_argument("--load", default="F:/VQA/相关代码/X-GGM-main/model/model_LXRT", type=str, help="预训练模型")
    # parser.add_argument("--load_lxmert", default="F:/VQA/相关代码/X-GGM-main/model", type=str, help="预训练模型")

    parser.add_argument("--load_lxmert", default=None, type=str, help="预训练模型")
    parser.add_argument("--load_lxmert_qa", default=None, type=str, help="预训练模型")
    parser.add_argument("--gnn", default="GCN", type=str, help="图神经网络选择")
    parser.add_argument("--num_layer", default=2, type=int, help="层数")
    parser.add_argument("--num_workers", default=0, type=int, help="层数")
    parser.add_argument("--batch_size", default=24, type=int, help="层数")
    parser.add_argument("--lr", default=5e-6, type=int, help="学习率") #可改
    parser.add_argument("--epochs", default=40, type=int, help="层数")
    parser.add_argument("--sigma", default=1.0, help="图神经网络选择")
    parser.add_argument("--delta", default=10, type=int, help="图神经网络选择")
    parser.add_argument("--tf_writer", default=True, type=str, help="tensorboard跟踪")
    parser.add_argument("--multiGPU", default=False, type=str, help="图神经网络选择")
    parser.add_argument("--optim", default="bert", type=str, help="图神经网络选择")
    parser.add_argument("--output", default="F:\VQA\相关代码\X-GGM-main\output", type=str, help="图神经网络选择")
    parser.add_argument("--tiny", default=False, type=bool, help="训练集大小")
    parser.add_argument("--fast", default=True, type=bool, help="训练集大小")
