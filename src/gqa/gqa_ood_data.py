...
VG_GQA_IMGFEAT_ROOT = 'F:\VQA\相关代码\X-GGM-main\data/gqa_imgfeat/'
...
class GQADataset:
    def __init__(self, splits: str):
        ...
        for split in self.splits:
            self.data.extend(json.load(open("F:\VQA\相关代码\X-GGM-main/data/gqa_ood/%s.json" % split)))
        ...
        self.ans2label = json.load(
            open("F:\VQA\相关代码\X-GGM-main\data/gqa_ood/trainval_ans2label.json"))
        self.label2ans = json.load(
            open("F:\VQA\相关代码\X-GGM-main\data/gqa_ood/trainval_label2ans.json"))
